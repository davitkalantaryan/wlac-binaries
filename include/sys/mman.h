...
#ifndef	__WLAC_BITS_MMAN_H__
#define	__WLAC_BITS_MMAN_H__	1
...
#ifndef MAP_SHARED
#define MAP_SHARED	PAGE_READWRITE
#endif
...
#endif   // #if !defined(__off_t_defined) & !defined(_OFF_T_DEFINED)
...
GEM_API_FAR void *mmap64(void *__addr, size_t __len, int __prot,
	int __flags, int __fd, __off64_t __offset);

/* Deallocate any mapping for the region starting at ADDR and extending LEN
bytes.  Returns 0 if successful, -1 for errors (and sets errno).  */
GEM_API_FAR int munmap(void *__addr, size_t __len) __THROW;
